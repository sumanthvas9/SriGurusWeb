...
urlpatterns = [
    ...
    re_path(r"auth/elogin", views.customer_login_email, name="api_elogin"),
    re_path(r"auth/slogin", views.customer_login_sms, name="api_slogin"),
    re_path(r"auth/social/login", views.customer_social_login, name="api_social_login"),
    re_path(r"auth/change_password", views.change_password, name="api_change_pwd"),
    re_path(r"auth/forgot_password", views.forgot_password, name="api_forgot_pwd"),
    re_path(r"auth/resend_eotp", views.resend_auth_otp_email, name="api_otp_eresend"),
    re_path(r"auth/resend_sotp", views.resend_auth_otp_email, name="api_otp_sresend"),
    re_path(r"auth/eotp_verify", views.auth_otp_validation_email, name="api_email_otp_valid"),
    re_path(r"auth/sotp_verify", views.auth_otp_validation_sms, name="api_sms_otp_valid"),
