...
urlpatterns = [
    ...
    re_path(r"auth/elogin", views.customer_login_email, name="api_login"),
    re_path(r"auth/slogin", views.customer_login_sms, name="api_login"),
    ...
    re_path(r"auth/resend_eotp", views.resend_auth_otp_email, name="api_otp_resend"),
    re_path(r"auth/resend_sotp", views.resend_auth_otp_sms, name="api_otp_resend"),
